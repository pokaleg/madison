...
Output: JSON-compatible result written to logs/sentinel-a3-datapipeline-convert-to-file.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/sentinel-a3-datapipeline-convert-to-file.json'
...
if __name__ == "__main__":
    ...
    write_json(convert_to_file(payload["data"]), payload["output"])
