...
Output: JSON-compatible result written to logs/sentinel-a3-datapipeline-read-write-files-from-disk4.json when --output is supplied.
...
NODE_NAME = 'Read/Write Files from Disk4'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/sentinel-a3-datapipeline-read-write-files-from-disk4.json'
...
def read_write_files_from_disk4(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(read_write_files_from_disk4(payload["data"]), payload["output"])
