...
Output: JSON-compatible result written to logs/bykov-denis-a3-workflow-convert-to-file.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/bykov-denis-a3-workflow-convert-to-file.json'
