...
Output: JSON-compatible result written to logs/sentinel-a3-datapipeline-convert-to-file1.json when --output is supplied.
...
NODE_NAME = 'Convert to File1'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/sentinel-a3-datapipeline-convert-to-file1.json'
...
def convert_to_file1(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(convert_to_file1(payload["data"]), payload["output"])
