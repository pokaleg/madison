...
Output: JSON-compatible result written to logs/singh-vaibhav-a3-intelligence-agent-data-collection-save-csv.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/singh-vaibhav-a3-intelligence-agent-data-collection-save-csv.json'
...
def save_csv(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(save_csv(payload["data"]), payload["output"])
