...
Output: JSON-compatible result written to logs/maddukuri-satwika-a3-workflow-limit-gct.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/maddukuri-satwika-a3-workflow-limit-gct.json'
...
def limit_gct(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(limit_gct(payload["data"]), payload["output"])
