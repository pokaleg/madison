...
Output: JSON-compatible result written to logs/maddukuri-satwika-a3-workflow-export-to-csv.json when --output is supplied.
...
NODE_NAME = 'Export to CSV'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/maddukuri-satwika-a3-workflow-export-to-csv.json'
...
def export_to_csv(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(export_to_csv(payload["data"]), payload["output"])
