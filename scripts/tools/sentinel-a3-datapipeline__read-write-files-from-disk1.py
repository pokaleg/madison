...
Output: JSON-compatible result written to logs/sentinel-a3-datapipeline-read-write-files-from-disk1.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/sentinel-a3-datapipeline-read-write-files-from-disk1.json'
