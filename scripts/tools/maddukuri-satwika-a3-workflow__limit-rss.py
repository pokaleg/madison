...
Output: JSON-compatible result written to logs/maddukuri-satwika-a3-workflow-limit-rss.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/maddukuri-satwika-a3-workflow-limit-rss.json'
...
def limit_rss(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(limit_rss(payload["data"]), payload["output"])
