...
Output: JSON-compatible result written to logs/sentinel-a3-datapipeline-read-write-files-from-disk3.json when --output is supplied.
...
Recipe: recipes/sentinel-a3-datapipeline.md
"""
...
WORKFLOW_NAME = 'Sentinel A3 DataPipeline'
WORKFLOW_SLUG = 'sentinel-a3-datapipeline'
NODE_NAME = 'Read/Write Files from Disk3'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/sentinel-a3-datapipeline-read-write-files-from-disk3.json'
...
def read_write_files_from_disk3(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(read_write_files_from_disk3(payload["data"]), payload["output"])
