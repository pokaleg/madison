...
Output: JSON-compatible result written to logs/madison-persona-pipeline-a3-read-write-files-from-disk1.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/madison-persona-pipeline-a3-read-write-files-from-disk1.json'
...
if __name__ == "__main__":
    ...
    write_json(read_write_files_from_disk1(payload["data"]), payload["output"])
