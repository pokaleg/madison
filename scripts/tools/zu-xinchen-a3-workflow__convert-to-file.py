...
Output: JSON-compatible result written to logs/zu-xinchen-a3-workflow-convert-to-file.json when --output is supplied.
...
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/zu-xinchen-a3-workflow-convert-to-file.json'
