...
Output: JSON-compatible result written to logs/maddukuri-satwika-a3-workflow-limit-phishing.json when --output is supplied.
...
Recipe: recipes/maddukuri-satwika-a3-workflow.md
"""
...
WORKFLOW_NAME = 'Maddukuri Satwika A3 Workflow'
WORKFLOW_SLUG = 'maddukuri-satwika-a3-workflow'
NODE_NAME = 'Limit Phishing'
NODE_TYPE = 'n8n-nodes-base.limit'
CLASSIFICATION = 'tool'
DEFAULT_OUTPUT = 'logs/maddukuri-satwika-a3-workflow-limit-phishing.json'
...
def limit_phishing(payload: Any) -> dict[str, Any]:
    """Produce a deterministic local analysis, output contract, or live-action handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(limit_phishing(payload["data"]), payload["output"])
