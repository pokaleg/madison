...
Output: JSON-compatible result written to data/verified/bykov-denis-a3-workflow/code-in-javascript.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/bykov-denis-a3-workflow/code-in-javascript.json'
