...
Output: JSON-compatible result written to data/verified/sentinel-a3-datapipeline/code-in-javascript3.json when --output is supplied.
...
NODE_NAME = 'Code in JavaScript3'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/sentinel-a3-datapipeline/code-in-javascript3.json'
...
def code_in_javascript3(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(code_in_javascript3(payload["data"]), payload["output"])
