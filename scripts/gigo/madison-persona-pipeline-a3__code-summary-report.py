...
Output: JSON-compatible result written to data/verified/madison-persona-pipeline-a3/code-summary-report.json when --output is supplied.
...
NODE_NAME = 'Code: Summary Report'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/madison-persona-pipeline-a3/code-summary-report.json'
...
def code_summary_report(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(code_summary_report(payload["data"]), payload["output"])
