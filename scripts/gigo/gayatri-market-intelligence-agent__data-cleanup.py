...
Output: JSON-compatible result written to data/verified/gayatri-market-intelligence-agent/data-cleanup.json when --output is supplied.
...
Recipe: recipes/gayatri-market-intelligence-agent.md
"""
...
WORKFLOW_NAME = 'Gayatri Market Intelligence Agent'
WORKFLOW_SLUG = 'gayatri-market-intelligence-agent'
NODE_NAME = 'Data Cleanup'
NODE_TYPE = 'n8n-nodes-base.set'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/gayatri-market-intelligence-agent/data-cleanup.json'
...
def data_cleanup(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(data_cleanup(payload["data"]), payload["output"])
