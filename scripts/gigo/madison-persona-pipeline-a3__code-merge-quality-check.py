...
Output: JSON-compatible result written to data/verified/madison-persona-pipeline-a3/code-merge-quality-check.json when --output is supplied.
...
NODE_NAME = 'Code: Merge + Quality Check'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/madison-persona-pipeline-a3/code-merge-quality-check.json'
...
def code_merge_quality_check(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(code_merge_quality_check(payload["data"]), payload["output"])
