...
Output: JSON-compatible result written to data/verified/sentinel-a3-datapipeline/code-in-javascript2.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/sentinel-a3-datapipeline/code-in-javascript2.json'
...
def code_in_javascript2(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(code_in_javascript2(payload["data"]), payload["output"])
