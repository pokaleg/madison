...
Output: JSON-compatible result written to data/verified/bykov-denis-a3-workflow/code-in-javascript1.json when --output is supplied.
...
Recipe: recipes/bykov-denis-a3-workflow.md
"""
...
WORKFLOW_NAME = 'Bykov Denis A3 Workflow'
WORKFLOW_SLUG = 'bykov-denis-a3-workflow'
NODE_NAME = 'Code in JavaScript1'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/bykov-denis-a3-workflow/code-in-javascript1.json'
