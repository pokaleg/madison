...
Output: JSON-compatible result written to data/verified/madison-persona-pipeline-a3/code-parse-cdc.json when --output is supplied.
...
NODE_NAME = 'Code: Parse CDC'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/madison-persona-pipeline-a3/code-parse-cdc.json'
...
def code_parse_cdc(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(code_parse_cdc(payload["data"]), payload["output"])
