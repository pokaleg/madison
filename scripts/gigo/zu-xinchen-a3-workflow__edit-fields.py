...
Output: JSON-compatible result written to data/verified/zu-xinchen-a3-workflow/edit-fields.json when --output is supplied.
...
Recipe: recipes/zu-xinchen-a3-workflow.md
"""
...
WORKFLOW_NAME = 'Zu Xinchen A3 Workflow'
WORKFLOW_SLUG = 'zu-xinchen-a3-workflow'
NODE_NAME = 'Edit Fields'
NODE_TYPE = 'n8n-nodes-base.set'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/zu-xinchen-a3-workflow/edit-fields.json'
...
def edit_fields(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(edit_fields(payload["data"]), payload["output"])
