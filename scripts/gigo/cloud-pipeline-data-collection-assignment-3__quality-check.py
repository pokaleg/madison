...
Output: JSON-compatible result written to data/verified/cloud-pipeline-data-collection-assignment-3/quality-check.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/cloud-pipeline-data-collection-assignment-3/quality-check.json'
...
def quality_check(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(quality_check(payload["data"]), payload["output"])
