...
Output: JSON-compatible result written to data/verified/sentinel-a3-datapipeline/code-in-javascript.json when --output is supplied.
...
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/sentinel-a3-datapipeline/code-in-javascript.json'
...
def code_in_javascript(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(code_in_javascript(payload["data"]), payload["output"])
