...
Output: JSON-compatible result written to data/verified/maddukuri-satwika-a3-workflow/parse-cisa-xml.json when --output is supplied.
...
NODE_NAME = 'Parse CISA XML'
NODE_TYPE = 'n8n-nodes-base.code'
CLASSIFICATION = 'gigo'
DEFAULT_OUTPUT = 'data/verified/maddukuri-satwika-a3-workflow/parse-cisa-xml.json'
...
def parse_cisa_xml(payload: Any) -> dict[str, Any]:
    """Clean, normalize, validate, or deduplicate JSON-compatible records for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(parse_cisa_xml(payload["data"]), payload["output"])
