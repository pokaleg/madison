...
Output: JSON-compatible result written to data/raw/maddukuri-satwika-a3-workflow/extract-from-file.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/maddukuri-satwika-a3-workflow/extract-from-file.json'
...
if __name__ == "__main__":
    ...
    write_json(extract_from_file(payload["data"]), payload["output"])
