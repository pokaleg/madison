...
Output: JSON-compatible result written to data/raw/gayatri-market-intelligence-agent/amazon-news-rss.json when --output is supplied.
...
NODE_NAME = 'Amazon News RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/gayatri-market-intelligence-agent/amazon-news-rss.json'
...
def amazon_news_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(amazon_news_rss(payload["data"]), payload["output"])
