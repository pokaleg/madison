...
Output: JSON-compatible result written to data/raw/zu-xinchen-a3-workflow/rss-read5.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/zu-xinchen-a3-workflow/rss-read5.json'
...
def rss_read5(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(rss_read5(payload["data"]), payload["output"])
