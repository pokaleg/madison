...
Output: JSON-compatible result written to data/raw/zu-xinchen-a3-workflow/rss-read1.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/zu-xinchen-a3-workflow/rss-read1.json'
...
if __name__ == "__main__":
    ...
    write_json(rss_read1(payload["data"]), payload["output"])
