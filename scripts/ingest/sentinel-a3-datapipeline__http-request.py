...
Output: JSON-compatible result written to data/raw/sentinel-a3-datapipeline/http-request.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/sentinel-a3-datapipeline/http-request.json'
...
if __name__ == "__main__":
    ...
    write_json(http_request(payload["data"]), payload["output"])
