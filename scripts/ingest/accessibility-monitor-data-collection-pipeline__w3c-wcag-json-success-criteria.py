"""Capture a local source snapshot or approval-required external source handoff for this converted n8n node.

Purpose: Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
Input: JSON-compatible payload from stdin, --input, or a small sample.
Output: JSON-compatible result written to data/raw/accessibility-monitor-data-collection-pipeline/w3c-wcag-json-success-criteria.json when --output is supplied.
...
NODE_NAME = 'W3C WCAG JSON - Success Criteria'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/accessibility-monitor-data-collection-pipeline/w3c-wcag-json-success-criteria.json'
...
def w3c_wcag_json_success_criteria(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(w3c_wcag_json_success_criteria(payload["data"]), payload["output"])
