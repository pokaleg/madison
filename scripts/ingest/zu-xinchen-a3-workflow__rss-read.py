...
Output: JSON-compatible result written to data/raw/zu-xinchen-a3-workflow/rss-read.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/zu-xinchen-a3-workflow/rss-read.json'
...
if __name__ == "__main__":
    ...
    write_json(rss_read(payload["data"]), payload["output"])
