...
Output: JSON-compatible result written to data/raw/sentinel-a3-datapipeline/read-write-files-from-disk.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/sentinel-a3-datapipeline/read-write-files-from-disk.json'
