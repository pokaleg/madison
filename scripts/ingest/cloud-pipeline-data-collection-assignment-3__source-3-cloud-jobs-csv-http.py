...
Output: JSON-compatible result written to data/raw/cloud-pipeline-data-collection-assignment-3/source-3-cloud-jobs-csv-http.json when --output is supplied.
...
NODE_NAME = 'Source 3: Cloud Jobs CSV (HTTP)'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/cloud-pipeline-data-collection-assignment-3/source-3-cloud-jobs-csv-http.json'
...
def source_3_cloud_jobs_csv_http(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(source_3_cloud_jobs_csv_http(payload["data"]), payload["output"])
