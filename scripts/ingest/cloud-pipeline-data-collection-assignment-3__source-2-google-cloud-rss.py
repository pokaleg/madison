...
Output: JSON-compatible result written to data/raw/cloud-pipeline-data-collection-assignment-3/source-2-google-cloud-rss.json when --output is supplied.
...
NODE_NAME = 'Source 2: Google Cloud RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/cloud-pipeline-data-collection-assignment-3/source-2-google-cloud-rss.json'
...
def source_2_google_cloud_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(source_2_google_cloud_rss(payload["data"]), payload["output"])
