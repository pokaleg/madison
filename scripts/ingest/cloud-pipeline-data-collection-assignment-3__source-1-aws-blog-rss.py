...
Output: JSON-compatible result written to data/raw/cloud-pipeline-data-collection-assignment-3/source-1-aws-blog-rss.json when --output is supplied.
...
NODE_NAME = 'Source 1: AWS Blog RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/cloud-pipeline-data-collection-assignment-3/source-1-aws-blog-rss.json'
...
def source_1_aws_blog_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(source_1_aws_blog_rss(payload["data"]), payload["output"])
