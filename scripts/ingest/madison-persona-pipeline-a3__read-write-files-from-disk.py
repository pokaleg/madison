...
Output: JSON-compatible result written to data/raw/madison-persona-pipeline-a3/read-write-files-from-disk.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/madison-persona-pipeline-a3/read-write-files-from-disk.json'
...
if __name__ == "__main__":
    ...
    write_json(read_write_files_from_disk(payload["data"]), payload["output"])
