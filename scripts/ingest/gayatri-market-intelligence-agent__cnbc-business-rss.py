...
Output: JSON-compatible result written to data/raw/gayatri-market-intelligence-agent/cnbc-business-rss.json when --output is supplied.
...
NODE_NAME = 'CNBC Business RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/gayatri-market-intelligence-agent/cnbc-business-rss.json'
...
def cnbc_business_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(cnbc_business_rss(payload["data"]), payload["output"])
