...
Output: JSON-compatible result written to data/raw/singh-vaibhav-a3-intelligence-agent-data-collection/http-huggingface.json when --output is supplied.
...
NODE_NAME = 'HTTP - HuggingFace'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/singh-vaibhav-a3-intelligence-agent-data-collection/http-huggingface.json'
...
def http_huggingface(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(http_huggingface(payload["data"]), payload["output"])
