...
Output: JSON-compatible result written to data/raw/nguyen-duc-a3-public-signal-pipeline/http-github-search.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/nguyen-duc-a3-public-signal-pipeline/http-github-search.json'
