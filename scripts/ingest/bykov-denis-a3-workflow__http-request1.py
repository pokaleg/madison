...
Output: JSON-compatible result written to data/raw/bykov-denis-a3-workflow/http-request1.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/bykov-denis-a3-workflow/http-request1.json'
...
if __name__ == "__main__":
    ...
    write_json(http_request1(payload["data"]), payload["output"])
