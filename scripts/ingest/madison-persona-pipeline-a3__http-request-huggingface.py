...
Output: JSON-compatible result written to data/raw/madison-persona-pipeline-a3/http-request-huggingface.json when --output is supplied.
...
NODE_NAME = 'HTTP Request: HuggingFace'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/madison-persona-pipeline-a3/http-request-huggingface.json'
...
def http_request_huggingface(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(http_request_huggingface(payload["data"]), payload["output"])
