...
Output: JSON-compatible result written to data/raw/singh-vaibhav-a3-intelligence-agent-data-collection/rss-techcrunch.json when --output is supplied.
...
NODE_NAME = 'RSS - TechCrunch'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/singh-vaibhav-a3-intelligence-agent-data-collection/rss-techcrunch.json'
...
def rss_techcrunch(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(rss_techcrunch(payload["data"]), payload["output"])
