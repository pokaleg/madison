...
Output: JSON-compatible result written to data/raw/sentinel-a3-datapipeline/extract-from-file.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/sentinel-a3-datapipeline/extract-from-file.json'
