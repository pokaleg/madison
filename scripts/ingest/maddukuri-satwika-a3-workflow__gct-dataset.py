...
Output: JSON-compatible result written to data/raw/maddukuri-satwika-a3-workflow/gct-dataset.json when --output is supplied.
...
NODE_NAME = 'GCT Dataset'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/maddukuri-satwika-a3-workflow/gct-dataset.json'
...
def gct_dataset(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(gct_dataset(payload["data"]), payload["output"])
