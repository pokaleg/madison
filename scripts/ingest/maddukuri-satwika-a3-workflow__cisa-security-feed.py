...
Output: JSON-compatible result written to data/raw/maddukuri-satwika-a3-workflow/cisa-security-feed.json when --output is supplied.
...
NODE_NAME = 'CISA Security Feed'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/maddukuri-satwika-a3-workflow/cisa-security-feed.json'
...
def cisa_security_feed(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(cisa_security_feed(payload["data"]), payload["output"])
