...
Output: JSON-compatible result written to data/raw/sentinel-a3-datapipeline/cisa-rss-read.json when --output is supplied.
...
NODE_NAME = 'CISA RSS Read'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/sentinel-a3-datapipeline/cisa-rss-read.json'
...
def cisa_rss_read(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(cisa_rss_read(payload["data"]), payload["output"])
