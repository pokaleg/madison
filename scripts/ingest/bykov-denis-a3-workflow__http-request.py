...
Output: JSON-compatible result written to data/raw/bykov-denis-a3-workflow/http-request.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/bykov-denis-a3-workflow/http-request.json'
