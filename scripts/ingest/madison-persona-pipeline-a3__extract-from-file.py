...
Output: JSON-compatible result written to data/raw/madison-persona-pipeline-a3/extract-from-file.json when --output is supplied.
...
DEFAULT_OUTPUT = 'data/raw/madison-persona-pipeline-a3/extract-from-file.json'
