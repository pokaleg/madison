...
Output: JSON-compatible result written to data/raw/maddukuri-satwika-a3-workflow/phishing-dataset.json when --output is supplied.
...
NODE_NAME = 'Phishing Dataset'
NODE_TYPE = 'n8n-nodes-base.readWriteFile'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/maddukuri-satwika-a3-workflow/phishing-dataset.json'
...
def phishing_dataset(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(phishing_dataset(payload["data"]), payload["output"])
