...
Output: JSON-compatible result written to data/raw/maddukuri-satwika-a3-workflow/extract-from-file1.json when --output is supplied.
...
NODE_NAME = 'Extract from File1'
NODE_TYPE = 'n8n-nodes-base.extractFromFile'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/maddukuri-satwika-a3-workflow/extract-from-file1.json'
...
def extract_from_file1(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(extract_from_file1(payload["data"]), payload["output"])
