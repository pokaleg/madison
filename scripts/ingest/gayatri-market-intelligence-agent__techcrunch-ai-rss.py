...
Output: JSON-compatible result written to data/raw/gayatri-market-intelligence-agent/techcrunch-ai-rss.json when --output is supplied.
...
NODE_NAME = 'TechCrunch AI RSS'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/gayatri-market-intelligence-agent/techcrunch-ai-rss.json'
...
def techcrunch_ai_rss(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(techcrunch_ai_rss(payload["data"]), payload["output"])
