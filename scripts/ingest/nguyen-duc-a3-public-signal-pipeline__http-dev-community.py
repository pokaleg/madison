...
Output: JSON-compatible result written to data/raw/nguyen-duc-a3-public-signal-pipeline/http-dev-community.json when --output is supplied.
...
NODE_NAME = 'HTTP - DEV Community'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/nguyen-duc-a3-public-signal-pipeline/http-dev-community.json'
...
def http_dev_community(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(http_dev_community(payload["data"]), payload["output"])
