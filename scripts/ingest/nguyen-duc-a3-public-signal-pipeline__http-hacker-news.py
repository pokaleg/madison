...
Output: JSON-compatible result written to data/raw/nguyen-duc-a3-public-signal-pipeline/http-hacker-news.json when --output is supplied.
...
NODE_NAME = 'HTTP - Hacker News'
NODE_TYPE = 'n8n-nodes-base.httpRequest'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/nguyen-duc-a3-public-signal-pipeline/http-hacker-news.json'
...
def http_hacker_news(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(http_hacker_news(payload["data"]), payload["output"])
