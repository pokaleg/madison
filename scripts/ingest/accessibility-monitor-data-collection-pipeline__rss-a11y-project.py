...
Output: JSON-compatible result written to data/raw/accessibility-monitor-data-collection-pipeline/rss-a11y-project.json when --output is supplied.
...
NODE_NAME = 'RSS - A11y Project'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/accessibility-monitor-data-collection-pipeline/rss-a11y-project.json'
...
def rss_a11y_project(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(rss_a11y_project(payload["data"]), payload["output"])
