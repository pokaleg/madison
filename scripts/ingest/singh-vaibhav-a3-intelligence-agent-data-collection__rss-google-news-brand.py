...
Output: JSON-compatible result written to data/raw/singh-vaibhav-a3-intelligence-agent-data-collection/rss-google-news-brand.json when --output is supplied.
...
NODE_NAME = 'RSS - Google News (Brand)'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/singh-vaibhav-a3-intelligence-agent-data-collection/rss-google-news-brand.json'
...
def rss_google_news_brand(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(rss_google_news_brand(payload["data"]), payload["output"])
