...
Output: JSON-compatible result written to data/raw/accessibility-monitor-data-collection-pipeline/rss-webaim-blog.json when --output is supplied.
...
NODE_NAME = 'RSS - WebAIM Blog'
NODE_TYPE = 'n8n-nodes-base.rssFeedRead'
CLASSIFICATION = 'ingest'
DEFAULT_OUTPUT = 'data/raw/accessibility-monitor-data-collection-pipeline/rss-webaim-blog.json'
...
def rss_webaim_blog(payload: Any) -> dict[str, Any]:
    """Capture a local source snapshot or approval-required external source handoff for this converted n8n node.
...
if __name__ == "__main__":
    ...
    write_json(rss_webaim_blog(payload["data"]), payload["output"])
